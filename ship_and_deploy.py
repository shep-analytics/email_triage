...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--key-file", required=True, help="Service account key JSON for gcloud auth")
...
def deploy(key_file: str, region: str, service: str, skip_build: bool) -> None:
    args = [
        sys.executable,
        "deploy_cloud_run.py",
        "--key-file",
...
def main() -> int:
    ...
    try:
        ...
        deploy(str(key_path), args.region, args.service, args.skip_build)
